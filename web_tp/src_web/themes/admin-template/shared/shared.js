...
var strRollColor = '#fff000';
var strRowOneColor = '#fff';
var strRowTwoColor = '#fff';
var strRowOne2Color = '#fff';
var strRowTwo2Color = '#fff';
...
function rollTR(strID, nState) {
	var ctlCB = document.getElementById( strID);
	var ctlTR = document.getElementById( strID);
