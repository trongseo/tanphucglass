...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr>
        ...
        <td width="100%" align="right" class="top_section">
               <?php echo  Yii::app()->session['full_name']; ?>/ <?php echo  Yii::app()->session['email']; ?>
        ...
        <td colspan="2">
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-left: 1px solid #E0E7F6;
                ...
                <tr style="background: url(<?php echo Yii::app()->theme->baseUrl; ?>/images/mainbar-background.gif) repeat-x;">
                    ...
                    <td align="center">
                        <b><a class="bar1" href="index.php?r=tuserexam/index">Exam of users</a></b>
                    </td>
                    <td align="center">
                        <b><a class="bar1" href="index.php?r=testmanagers/index">Exam Manager</a></b>
                    </td>
                    <td align="center">
                        <b><a class="bar1" href="index.php?r=questions">Question Bank</a></b>
                    </td>

                    <td align="center">
                        <b><a class="bar1" href="index.php?r=reportusers">Reports Users</a></b>
                    </td>
                    <td align="center">
                        <b><a class="bar1" href="index.php?r=user">Users manager</a></b>
                    </td>
                    <td align="center">
